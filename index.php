        ...
        <div class="container">
            <div class="row">
                <div class="mbr-section col-md-10 col-md-offset-1 text-xs-center">
                    ...
                    <div class="mbr-section-btn">   <a class="btn btn-lg btn-white-outline btn-white" href=""><span class="etl-icon icon-calendar mbr-iconfont mbr-iconfont-btn"></span>קבע תור ללא רישום</a> <a class="btn btn-lg btn-white-outline btn-white" href="Register.php"><span class="etl-icon icon-profile-male mbr-iconfont mbr-iconfont-btn"></span>הירשם</a> <a class="btn btn-lg btn-white-outline btn-white" href="file:///C:/Users/EstiAlishaeva/AppData/Local/Temp/Mobirise-GN2aKw/20170428_142000/WorkProfile.html" target="_self"><span class="etl-icon icon-key mbr-iconfont mbr-iconfont-btn"></span>התחבר/י</a>  <a class="btn btn-lg btn-white-outline btn-white" href=""><span class="socicon socicon-viber mbr-iconfont mbr-iconfont-btn"></span>צור קשר</a> <a class="btn btn-lg btn-white-outline btn-white" href=""><span class="etl-icon icon-scissors mbr-iconfont mbr-iconfont-btn"></span>אודות</a>  </div>
                </div>
            </div>
        </div>
    </div>
